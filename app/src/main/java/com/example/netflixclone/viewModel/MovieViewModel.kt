...
class MovieViewModel @Inject constructor(
    ...
    private val _movieDetailsResponse: MutableLiveData<NetworkResult<MovieDetails>> =
        MutableLiveData()
    var movieDetailsResponse: LiveData<NetworkResult<MovieDetails>> = _movieDetailsResponse

    private val _searchMovieResponse: MutableLiveData<NetworkResult<MovieResponse>> =
        MutableLiveData()
    var searchMovieResponse: LiveData<NetworkResult<MovieResponse>> = _searchMovieResponse

    val MovieRoom: LiveData<List<MoviesResult>> = movieRepo.getAll();
